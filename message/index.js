                ...
                case 'getstatus': {
                    try {
                        ...
                        if (args.length == 0) {
                            ...
                            bocchi.sendTextWithMentions(from, storyList)
                            return sendText('Tag user lah')
                        }
                        bocchi.sendTextWithMentions(from, `_fetching whatsapp status from @${param}_`)
                        await sleep(2000)
                        ...
                        for (let story of userStories) {
                            if (story.type == 'chat') {
                                ...
                                await bocchi.sendTextWithMentions(from, capt)
                                ...
                                await bocchi.sendImage(from, `data:${story.mimetype};base64,${mediaData.toString('base64')}`, 'file' + story.type == 'image' ? '.jpg' : '.mp4', capt, id)
                            }
                        }
                    } catch (error) {
                        printError(error)
